echo "# treino" >> README.md
git init
git add README.md
git commit -m "first commit"
git remote add origin https://github.com/ChagaPeridot/treino.git
...
$('.formphp').on('submit', function() {
	var emailContato = "gabrielchagarela@gmail.com"; // Escreva aqui o seu e-mail
